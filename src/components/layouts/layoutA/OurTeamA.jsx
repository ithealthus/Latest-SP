  ...
  return (
    <section className="bg-white px-4 md:px-12 py-12">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-primary font-title text-3xl md:text-4xl font-semibold font-roboto mb-2">
          {team.title}
        </h2>
        <p className="text-base sm:text-lg md:text-lg lg:text-xl xl:text-2xl text-black font-title font-medium font-roboto mb-8">
          {team.subTitle}
        </p>
