const audiologySpeechTherapy = {
  slug: "audiology-speech-therapy",
  label: "Audiology & Speech Therapy",
  keywords: [
    "audiology clinic in Trivandrum",
    "speech therapy in Trivandrum",
    "hearing test Trivandrum",
    "speech therapist in Trivandrum",
    "child speech therapy Trivandrum",
    "hearing aid centre Trivandrum",
    "best audiologist in Trivandrum",
    "stammering treatment Trivandrum"
  ],
  breadcrumb: ["Home", "Services", "Audiology & Speech Therapy"],
  hero: {
    title: "Audiology & Speech Therapy at SP Medifort Hospital",
    tagline: "Helping You Hear Better and Speak Freely — Because Every Voice Matters."
  },
  overview: {
    heading: "Overview",
    content: `At SP Medifort Hospital, our Audiology & Speech Therapy Unit offers specialized care for individuals experiencing hearing, speech, language, and communication disorders. We work with both children and adults to assess, diagnose, and treat hearing loss, speech delays, stammering, and language disorders through evidence-based, personalized therapy plans.
Recognized as a leading audiology clinic in Trivandrum, our unit is equipped with modern diagnostic and therapeutic tools operated by certified audiologists and speech-language pathologists.`
  },
  services: {
    ...
    points: [
      ...
      "Speech Therapy for Stammering, Lisping, Misarticulation",
  ...
  technologies: {
    ...
    points: [
      ...
      "Early Hearing Detection Programs for Newborns"
    ]
  },
  scopeOfCare: {
    heading: "When Should You Use This Service?",
    points: [
  ...
  whyChoose: {
    heading: "📍 Why Choose SP Medifort Audiology & Speech Therapy?",
    points: [
      ...
      "Personalized therapy with parental involvement",
  ...
  appointmentSection: {
    ...
    actions: [
      ...
      { label: "WhatsApp Now", type: "whatsapp", href: "#" }
    ]
  }
};

export default audiologySpeechTherapy;
