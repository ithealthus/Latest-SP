...
const data = {
  hero: {
    title: "EMG · EEG · ECG Diagnostics in Thiruvananthapuram ",
    tagline:
  ...
  whenToUse: [
    ...
    "Sleep disorders such as insomnia, sleep apnea, or unexplained daytime fatigue (EEG/Polysomnography support)"
  ],
  whyChoose: [
