...
const data = {
  hero: {
    title: "Advanced Cardiac Cath Lab in Thiruvananthapuram",
    tagline:
  ...
  whenToUse: [
    ...
    "For routine cardiac health check-ups in individuals with diabetes, hypertension, or strong family history of heart disease"
  ],
  whyChoose: [
