...
const data = {
  hero: {
    title: "Best Rehabilitation & Physiotherapy Center in Thiruvananthapuram",
    tagline:
  ...
  whatWeOffer: [
    ...
    "Auditory Verbal Therapy (AVT) for Children with Hearing Loss",
  ],
  team: [
  ...
  whenToUse: [
    ...
    "Difficulty communicating in noisy environments despite normal hearing tests"
  ],
  whyChoose: [
          ...
          <div className="lg:flex items-start gap-8">
            <div className="w-full  px-4 md:px-8 pb-6 ">
              ...
              <div className="text-left ">
                <h1 className="text-3xl py-4 md:text-4xl font-bold text-primary">
                  {data.hero?.title}
                </h1>
              </div>
              <div className="text-left">
              ...
              <div className="mt-6 sm:mt-4 md:mt-8">
              <Link
                href='/find-a-doctor'
