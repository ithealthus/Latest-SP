...
const data = {
  hero: {
    title: "Best Clinical Laboratory in Thiruvananthapuram",
    tagline:
  ...
  whatWeOffer: [
    ...
    "Molecular Diagnostics (PCR-based Tests for Genetic & Infectious Diseases)"
  ],
  team: [
  ...
  whenToUse: [
    ...
    "Cancer screening and tumor marker tests for early detection"
  ],
  whyChoose: [
