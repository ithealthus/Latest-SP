...
const data = {
  hero: {
    title: "Best Home Nursing Services in Thiruvananthapuram ",
    tagline:
  ...
  whatWeOffer: [
    ...
    "Home-based vital signs monitoring (BP, sugar, oxygen, temperature tracking)"
  ],
  team: [
  ...
  whenToUse: [
    ...
    "For medication management and regular vital checks at home"
  ],
  whyChoose: [
