...
const techImg1 =
  "/images/services/medicalRecords/EMR-integrated-digital-storage-with-real-time-access.webp";
const techImg2 =
...
const data = {
  hero: {
    title: "Medical Records Hospital in Thiruvananthapuram",
    tagline:
  ...
  whenToUse: [
    ...
    "To access digital copies of reports for easy storage and future reference"
  ],
  whyChoose: [
