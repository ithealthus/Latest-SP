...
const data = {
  hero: {
    title: "Dietetics & Nutrition in Thiruvananthapuram",
    tagline:
  ...
  whatWeOffer: [
    ...
    "Geriatric nutrition care for healthy ageing and chronic disease support",
    "Sports and performance nutrition for athletes and active individuals"
  ],
  team: [
  ...
  whenToUse: [
    ...
    "For maternity, lactation, or fertility-related nutritional support"
  ],
  whyChoose: [
